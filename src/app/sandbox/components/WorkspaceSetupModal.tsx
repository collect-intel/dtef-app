...
import { BLUEPRINT_CONFIG_REPO_URL, BLUEPRINT_CONFIG_REPO_SLUG, EXPECTED_FORK_REPO_NAME } from '@/lib/configConstants';
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            <a href={BLUEPRINT_CONFIG_REPO_URL} target="_blank" rel="noopener noreferrer" className="text-primary hover:underline mx-1">
        ...
        <div className="py-4">
          <p className="text-sm text-muted-foreground">
            This will create a new repository under your GitHub account named <code className="bg-muted px-1 py-0.5 rounded">{EXPECTED_FORK_REPO_NAME}</code>.
