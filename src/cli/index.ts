...
import { backfillSummaryCommand, lightweightBackfillCommand, streamingSummariesCommand, dtefRebuildCommand } from './commands/backfill-summary';
...
cli.addCommand(dtefRebuildCommand);
