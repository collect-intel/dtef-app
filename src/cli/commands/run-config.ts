...
const localCommand = new Command('local')
    ...
    .option('--collections-repo-path <path>', 'Path to a local checkout of a collections repository (e.g., dtef-configs) to resolve model collection placeholders.')
...
const githubCommand = new Command('github')
    .description('Runs an evaluation from a blueprint on the configs GitHub repository.')
